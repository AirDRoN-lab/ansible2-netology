...
1) Как добавить символ "#" в начале строки  (найденной через regexp) в ansible при помощи модуля lineinfile (либо другого)? На данный момент удалось выполнить только replace.
